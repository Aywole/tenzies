    ...
    return (
        <main>
            ...
            {time.on && <Timer 
                ...
                time = {time.value}
            />}
            <h3 className="grey">Current time: {time.value}s</h3>
            
            <h1 className="title">Tenzies</h1>
            <h3 className="grey">Best time: {JSON.parse(localStorage.getItem("time")) || 0}s</h3>
            ...
            <span className="roll-value grey">Rolls: {roll}</span>
        </main>
    )
}